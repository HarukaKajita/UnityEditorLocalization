...
- **19 Sprachen** sind in der Einstellungs-UI und im mitgelieferten Beispielkatalog enthalten.
...
Fixieren Sie eine Version, indem Sie einen Release-Tag anhängen, z. B. `#1.2.1`. Sie können dieselbe URL auch direkt in `Packages/manifest.json` unter `dependencies` eintragen.
